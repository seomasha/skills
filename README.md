...
| Plugin | Skills | Scope |
|---|---|---|
| `core` | `/ai-workflow-analyzer` audit MCPs/skills/hooks/plugins for redundancy, duplicates, scope, unused · `/model-advisor` cheapest model per plan task · `/prompt-engineer` | user |
